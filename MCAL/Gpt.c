...
/* GBT Handlers ________________________________________________*/
...
void TIMER1A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)TIMER1_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
void TIMER2A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)TIMER2_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
void TIMER3A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)TIMER3_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
void TIMER4A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)TIMER4_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
void TIMER5A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)TIMER5_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
...
void WTIMER1A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)WTIMER1_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
...
void WTIMER2A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)WTIMER2_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
void WTIMER3A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)WTIMER3_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
void WTIMER4A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)WTIMER4_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
void WTIMER5A_Handler (void)
{
    ...
    /* Clear interrupt flag */
	  *(volatile uint32*)((volatile uint8*)WTIMER5_BASE_ADDRESS + GPTMICR_OFFSET) = 0x1;
}
