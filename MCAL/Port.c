...
* \Description     : Function that sets a pin as analog                                    
*                                                                             
...
/******************************************************************************
* \Syntax          : void Port_setPinDigital ( const Port_ConfigType* ConfigPtr )     
* \Description     : Function that sets the pin as digital                                
*                                                                             
* \Sync\Async      : Synchronous                                               
* \Reentrancy      : Non Reentrant                                             
* \Parameters (in) : None                                                          
...
void Port_Init( const Port_ConfigType* ConfigPtr )
{
    ...
    volatile uint32* regPtr = NULL;  /* Pointer to current GPIOx base address */
    uint8 i = 0;                     /* i counter that loopsthrough configured Pins */
	  volatile uint32 delay_3clocks;   /* temporary variable we use to achieve 3 clock delay */
